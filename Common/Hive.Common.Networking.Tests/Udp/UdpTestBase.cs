...
public abstract class UdpTestBase
{
    ...
    protected UdpSession<ushort> _client;
    protected UdpAcceptor<ushort, Guid> _server;
    protected IPacketCodec<ushort> _codec;
    protected FakeUdpClientManager _clientManager;
    protected IDataDispatcher<UdpSession<ushort>> _dataDispatcher;
