...
{
    public sealed class OpenArrayBufferWriter<T> : IBufferWriter<T>
    {
        ...
        /// </exception>
        public OpenArrayBufferWriter(int initialCapacity)
        {
        ...
        /// <summary>
        /// Returns the buffer used to keep the data
        /// </summary>
        ...
        {
            throw new InvalidOperationException($"Capacity advance too far: [{capacity}]");
        }

        private static void ThrowOutOfMemoryException(uint capacity)
        {
            throw new OutOfMemoryException($"Capacity max size exceeded: [{capacity}]");
        }
    }
}