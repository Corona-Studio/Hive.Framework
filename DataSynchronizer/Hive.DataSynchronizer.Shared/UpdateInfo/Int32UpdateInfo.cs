...
{
    public class Int32UpdateInfo : AbstractUpdateInfoBase<int>
    {
        public Int32UpdateInfo(ushort objectSyncId, string propertyName, int newValue) : base(objectSyncId, propertyName, newValue)
        {
        }
        ...
        public override ReadOnlyMemory<byte> Serialize<TId>(IPacketCodec<TId> codec)
        {
            ...
            var packetIdMemory = codec.PacketIdMapper.GetPacketIdMemory(typeof(Int32UpdateInfo));
            ...
            var totalLength = sizeof(ushort) + sizeof(uint) + packetIdMemory.Length + sizeof(ushort) + sizeof(int) + propertyNameMemory.Length;
        ...
        public override AbstractUpdateInfoBase Deserialize(ReadOnlyMemory<byte> memory)
        {
            ...
            return new Int32UpdateInfo(objectSyncId, propertyName, newValue);
        }
    }
}