...
{
    public class UInt32UpdateInfo : AbstractUpdateInfoBase<uint>
    {
        public UInt32UpdateInfo(ushort objectSyncId, string propertyName, uint newValue) : base(objectSyncId, propertyName, newValue)
        {
        }
        ...
        public override AbstractUpdateInfoBase Deserialize(ReadOnlyMemory<byte> memory)
        {
            ...
            return new UInt32UpdateInfo(objectSyncId, propertyName, newValue);
        }
    }
}