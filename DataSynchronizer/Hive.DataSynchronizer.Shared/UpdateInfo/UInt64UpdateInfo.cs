...
{
    public class UInt64UpdateInfo : AbstractUpdateInfoBase<ulong>
    {
        public UInt64UpdateInfo(ushort objectSyncId, string propertyName, ulong newValue) : base(objectSyncId, propertyName, newValue)
        {
        }
        ...
        public override ReadOnlyMemory<byte> Serialize<TId>(IPacketCodec<TId> codec)
        {
            ...
            var packetIdMemory = codec.PacketIdMapper.GetPacketIdMemory(typeof(UInt64UpdateInfo));
            ...
            var totalLength = sizeof(ushort) + sizeof(uint) + packetIdMemory.Length + sizeof(ushort) + sizeof(ulong) + propertyNameMemory.Length;
        ...
        public override AbstractUpdateInfoBase Deserialize(ReadOnlyMemory<byte> memory)
        {
            ...
            return new UInt64UpdateInfo(objectSyncId, propertyName, newValue);
        }
    }
}