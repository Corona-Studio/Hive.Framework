...
{
    public class Int16UpdateInfo : AbstractUpdateInfoBase<short>
    {
        public Int16UpdateInfo(ushort objectSyncId, string propertyName, short newValue) : base(objectSyncId, propertyName, newValue)
        {
        }
        ...
        public override ReadOnlyMemory<byte> Serialize<TId>(IPacketCodec<TId> codec)
        {
            ...
            var packetIdMemory = codec.PacketIdMapper.GetPacketIdMemory(typeof(Int16UpdateInfo));
        ...
        public override AbstractUpdateInfoBase Deserialize(ReadOnlyMemory<byte> memory)
        {
            ...
            return new Int16UpdateInfo(objectSyncId, propertyName, newValue);
        }
    }
}